...
print()
print()
print('The least happy country 2015 was: ',
      data_2015['Country'].iloc[minvalueindex2015])
print('The least happy country 2016 was: ',
      data_2015['Country'].iloc[minvalueindex2016])
print('The least happy country 2017 was: ',
      data_2015['Country'].iloc[minvalueindex2017])
print('The least happy country 2018 was: ',
      data_2015['Country'].iloc[minvalueindex2018])
print('The least happy country 2019 was: ',
      data_2015['Country'].iloc[minvalueindex2019])
print()
print('The happiest country 2015 was: ',
      data_2015['Country'].iloc[maxvalueindex2015])
print('The happiest country 2016 was: ',
      data_2015['Country'].iloc[maxvalueindex2016])
print('The happiest country 2017 was: ',
      data_2015['Country'].iloc[maxvalueindex2017])
print('The happiest country 2018 was: ',
      data_2015['Country'].iloc[maxvalueindex2018])
print('The happitest country 2019 was: ',
      data_2015['Country'].iloc[maxvalueindex2019])
print()
print()
...
data1 = {'Score': [switzerland_2015, switzerland_2016, switzerland_2017,
                   switzerland_2018, switzerland_2019], 'Year': ['2015', '2016', '2017', '2018', '2019']}
...
data2 = {'Score': [benin_2015, benin_2016, benin_2017, benin_2018,
                   benin_2019], 'Year': ['2015', '2016', '2017', '2018', '2019']}
...
data3 = {'Score': [togo_2015, togo_2016, togo_2017, togo_2018,
                   togo_2019], 'Year': ['2015', '2016', '2017', '2018', '2019']}
...
data4 = {'Score': [burundi_2015, burundi_2016, burundi_2017, burundi_2018,
                   burundi_2019], 'Year': ['2015', '2016', '2017', '2018', '2019']}
data_burundi = pd.DataFrame(data4)


plt.plot(data_switzerland['Year'],
         data_switzerland['Score'], label='Switzerland', color = '#F9ADA0')
plt.plot(data_benin['Year'], data_benin['Score'], label='Benin', color = '#F9627D')
plt.plot(data_togo['Year'], data_togo['Score'], label='Togo', color = '#C65B7C')
